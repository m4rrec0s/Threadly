...
interface ModalFollowersProps {
  ...
  setIsModalFollowersOpen: (open: boolean) => void;
}
...
const ModalFollowers = ({
  ...
  return (
    <Dialog open onOpenChange={() => setIsModalFollowersOpen(false)}>
      <DialogContent className="p-0">
        <DialogHeader>
          <DialogTitle className="text-center py-2">Seguidores</DialogTitle>
        </DialogHeader>
